  ...
  ************************************************************************************************************/ 
  ...
  var browserIsMozilla = navigator.userAgent.indexOf('Mozilla')>=0?true:false;  
  var browserIsMSIE = navigator.userAgent.indexOf('MSIE')>=0?true:false;  
  ...
  if (browserIsMozilla && !browserIsMSIE){
  	slideSteps = 12;
  }
