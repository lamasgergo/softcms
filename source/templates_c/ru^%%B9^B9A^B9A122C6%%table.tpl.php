<?php /* Smarty version 2.6.19, created on 2010-03-02 20:48:25
         compiled from gallery/categories/table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'gallery/categories/table.tpl', 7, false),array('modifier', 'lang', 'gallery/categories/table.tpl', 7, false),array('modifier', 'truncate', 'gallery/categories/table.tpl', 21, false),array('modifier', 'date_format', 'gallery/categories/table.tpl', 26, false),array('modifier', 'default', 'gallery/categories/table.tpl', 26, false),)), $this); ?>
...
"></td>
          ...
          <td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['Description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 300, "...", true) : smarty_modifier_truncate($_tmp, 300, "...", true)); ?>
</td>
          <td>
...
" <?php echo $this->_tpl_vars['pub_ch']; ?>
 value="1" onclick="categories_publish(<?php echo $this->_tpl_vars['item']['ID']; ?>
,this.checked);">
		  </td>
