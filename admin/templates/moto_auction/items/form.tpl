<form id="EXForm" onsubmit="return false;"><input type="hidden"	id="RequiredFields" name="RequiredFields" value="Name, CategoryID, StartDate, EndDate">
<table border="0" cellpadding="5" cellspacing="0" class="content"
	...
	<tr valign="top">
	    ...
	    <tr>
	      <td>{$prefix|cat:"_StartDate"|lang}</td>
	      <td>
				<input type="text" readonly="readonly" name="StartDate" id="StartDate" value="{$items_arr[0].StartDate}" class="form_item">
				<input type="button" class="form_but" value="{lang calendar_select_date}" onclick="displayCalendar($(StartDate),'yyyy.mm.dd',this);"> 
	      </td>
	    </tr>
	    <tr>
	      <td>{$prefix|cat:"_EndDate"|lang}</td>
	      <td>
				<input type="text" readonly="readonly" name="EndDate" id="EndDate" value="{$items_arr[0].EndDate}" class="form_item">
				<input type="button" class="form_but" value="{lang calendar_select_date}" onclick="displayCalendar($(EndDate),'yyyy.mm.dd',this);"> 
	      </td>
	    </tr>
	    <tr>
