...
<html>
    <head>
        ...
        echo " (";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'exception', '5'), "statuscode", array(), "any"), "html");
        echo " ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'exception', '5'), "statustext", array(), "any"), "html");
        echo ")</title>
        <style type=\"text/css\">
            html { background: #eee }
