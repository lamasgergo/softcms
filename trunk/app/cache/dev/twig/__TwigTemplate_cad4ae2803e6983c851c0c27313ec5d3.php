...
/* C:\www\test\sandbox\app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/exception.twig */
class __TwigTemplate_cad4ae2803e6983c851c0c27313ec5d3 extends Twig_Template
{
...
" => "<br />")));
        echo "</h1>
            <h2><strong>";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'exception', '8'), "statuscode", array(), "any"), "html");
        echo "</strong> ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'exception', '8'), "statustext", array(), "any"), "html");
        echo " - ";
        ...
        if ($this->getContext($context, 'previous_count', '11')) {
            ...
            echo twig_escape_filter($this->env, ($this->getContext($context, 'previous_count', '12') > (1) ? ("s") : ("")), "html");
            echo ":</span>
                    <ul>
                        ";
            // line 14
    ...
    ";
        ...
        if ($this->getContext($context, 'logger', '31')) {
            ...
            if ($this->getAttribute($this->getContext($context, 'logger', '34'), "counterrors", array(), "any")) {
                ...
                echo " error";
                echo twig_escape_filter($this->env, ($this->getAttribute($this->getContext($context, 'logger', '35'), "counterrors", array(), "any") > (1) ? ("s") : ("")), "html");
                echo "</span>
                ";
            }
            // line 36
...
";
    ...
    {
        return "C:\\www\\test\\sandbox\\app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/exception.twig";
    }
}
