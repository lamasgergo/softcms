...
";
        ...
        echo twig_escape_filter($this->env, (200 == ($this->getAttribute($this->getContext($context, 'collector', '5'), "statuscode", array(), "any")) ? ("#3a3") : ("#a33")), "html");
        echo "\">";
