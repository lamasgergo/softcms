...
$this->env->getExtension("templating")->getContainer()->get("templating.helper.actions")->render("WebProfilerBundle:Profiler:toolbar", array("token" => $this->getContext($context, 'token', '14'), "position" => "normal")));
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context['name'] => $context['template']) {
            ...
            // line 20
            ob_start();
            echo twig_raw_filter($this->getAttribute($this->getContext($context, 'template', '20'), "block", array("menu", array("collector" => $this->getAttribute($this->getContext($context, 'profiler', '20'), "get", array($this->getContext($context, 'name', '20'), ), "method")), ), "method"));
            ...
            if ($this->getContext($context, 'menu', '21')) {
                ...
                echo twig_raw_filter($this->getContext($context, 'menu', '25'));
                echo "</a>
                        </li>
                    ";
            }
