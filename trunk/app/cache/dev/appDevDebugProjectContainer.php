...
class appDevDebugProjectContainer extends Container implements TaggedContainerInterface
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return WillNeverBeCalled A WillNeverBeCalled instance.
     */
    ...
    {
        return $this->services['router'] = new \Symfony\Component\Routing\Router($this->get('routing.loader'), 'C:\\www\\test\\sandbox\\app/config/routing_dev.yml', array('cache_dir' => 'C:\\www\\test\\sandbox\\app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'app'.'_'.'dev'.'UrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'app'.'UrlMatcher'));
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => 'C:\\www\\test\\sandbox\\app/cache/dev'.'/translations', 'debug' => true), $this->get('session', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        $this->services['translator'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => 'C:\\www\\test\\sandbox\\app/cache/dev'.'/translations', 'debug' => true), $this->get('session', ContainerInterface::NULL_ON_INVALID_REFERENCE));
        $instance->setFallbackLocale('en');
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SQLiteProfilerStorage('C:\\www\\test\\sandbox\\app/cache/dev/profiler.db', 86400);
    }
    ...
    {
        return $this->services['twig'] = new \Symfony\Bundle\TwigBundle\Environment($this, $this->get('twig.loader'), array('charset' => 'UTF-8', 'debug' => true, 'cache' => 'C:\\www\\test\\sandbox\\app/cache/dev/twig', 'strict_variables' => true));
    }
    ...
    /**
     * Gets the 'twig.extension.optimizer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Twig_Extension_Optimizer A Twig_Extension_Optimizer instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.dbal.logger.debug_class% instance.
     */
    protected function getDoctrine_Dbal_Logger_DebugService()
    {
        return $this->services['doctrine.dbal.logger.debug'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.dbal.logger_class% instance.
     */
    protected function getDoctrine_Dbal_LoggerService()
    {
        return $this->services['doctrine.dbal.logger'] = new \Symfony\Bundle\DoctrineBundle\Logger\DbalLogger($this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = call_user_func(array('Doctrine\\DBAL\\DriverManager', 'getConnection'), array('driverClass' => 'Doctrine\\DBAL\\Driver\\PDOMySql\\Driver', 'driverOptions' => array(), 'dbname' => 'shop', 'host' => 'localhost', 'user' => 'root'), $this->get('doctrine.dbal.default_connection.configuration'), $this->get('doctrine.dbal.default_connection.event_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.orm.metadata.annotation_class% instance.
     */
    protected function getDoctrine_Orm_MetadataDriver_AnnotationService()
    {
        return $this->services['doctrine.orm.metadata_driver.annotation'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('doctrine.orm.metadata_driver.annotation.reader'), array(0 => 'C:\\www\\test\\sandbox\\src\\Application\\UserBundle/Entity'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.orm.metadata.annotation_reader_class% instance.
     */
    protected function getDoctrine_Orm_MetadataDriver_Annotation_ReaderService()
    {
        $this->services['doctrine.orm.metadata_driver.annotation.reader'] = $instance = new \Doctrine\Common\Annotations\AnnotationReader();
        $instance->setAnnotationNamespaceAlias('Doctrine\\ORM\\Mapping\\', 'orm');
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.orm.metadata.xml_class% instance.
     */
    protected function getDoctrine_Orm_MetadataDriver_XmlService()
    {
        return $this->services['doctrine.orm.metadata_driver.xml'] = new \Doctrine\ORM\Mapping\Driver\XmlDriver(array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Object A %doctrine.orm.metadata.yml_class% instance.
     */
    protected function getDoctrine_Orm_MetadataDriver_YmlService()
    {
        return $this->services['doctrine.orm.metadata_driver.yml'] = new \Doctrine\ORM\Mapping\Driver\YamlDriver(array());
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setEntityNamespaces(array('UserBundle' => 'Application\\UserBundle\\Entity'));
        $instance->setMetadataCacheImpl($this->get('doctrine.orm.default_metadata_cache'));
        $instance->setQueryCacheImpl($this->get('doctrine.orm.default_query_cache'));
        $instance->setResultCacheImpl($this->get('doctrine.orm.default_result_cache'));
        $instance->setMetadataDriverImpl($this->get('doctrine.orm.metadata_driver'));
        $instance->setProxyDir('C:\\www\\test\\sandbox\\app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        $this->services['doctrine.orm.metadata_driver'] = $instance = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $instance->addDriver($this->get('doctrine.orm.metadata_driver.annotation'), 'Application\\UserBundle\\Entity');
    ...
    {
        return $this->services['doctrine.orm.default_metadata_cache'] = new \Doctrine\Common\Cache\ArrayCache();
    }
    ...
    {
        return $this->services['doctrine.orm.default_query_cache'] = new \Doctrine\Common\Cache\ArrayCache();
    }
    ...
    {
        return $this->services['doctrine.orm.default_result_cache'] = new \Doctrine\Common\Cache\ArrayCache();
    }
    ...
    {
        $this->services['zend.logger.writer.filesystem'] = $instance = new \Zend\Log\Writer\Stream('C:\\www\\test\\sandbox\\app/logs/dev.log');
...
');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\www\\test\\sandbox\\app/cache/dev',
            ...
            'kernel.bundles' => array(
                ...
                5 => 'Application\\UserBundle\\UserBundle',
            ...
            'routing.resource' => 'C:\\www\\test\\sandbox\\app/config/routing_dev.yml',
            'kernel.compiled_classes' => array(
                ...
                43 => 'Symfony\\Component\\Routing\\RouterInterface',
                44 => 'Symfony\\Component\\Routing\\Router',
                45 => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcherInterface',
                46 => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher',
                47 => 'Symfony\\Component\\Routing\\Generator\\UrlGeneratorInterface',
                48 => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator',
                49 => 'Symfony\\Component\\Routing\\Loader\\LoaderInterface',
                50 => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\LazyLoader',
                51 => 'Symfony\\Component\\HttpFoundation\\Session',
                52 => 'Symfony\\Component\\HttpFoundation\\SessionStorage\\SessionStorageInterface',
                53 => 'Symfony\\Component\\HttpFoundation\\ParameterBag',
                54 => 'Symfony\\Component\\HttpFoundation\\HeaderBag',
                55 => 'Symfony\\Component\\HttpFoundation\\Request',
                56 => 'Symfony\\Component\\HttpFoundation\\Response',
                57 => 'Symfony\\Component\\HttpFoundation\\ResponseHeaderBag',
                58 => 'Symfony\\Component\\HttpKernel\\BaseHttpKernel',
                59 => 'Symfony\\Component\\HttpKernel\\HttpKernel',
                60 => 'Symfony\\Component\\HttpKernel\\ResponseListener',
                61 => 'Symfony\\Component\\HttpKernel\\Controller\\ControllerResolver',
                62 => 'Symfony\\Component\\HttpKernel\\Controller\\ControllerResolverInterface',
                63 => 'Symfony\\Bundle\\FrameworkBundle\\RequestListener',
                64 => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\ControllerNameConverter',
                65 => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\ControllerResolver',
                66 => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\Controller',
                67 => 'Symfony\\Component\\EventDispatcher\\Event',
                68 => 'Symfony\\Component\\EventDispatcher\\EventDispatcher',
                69 => 'Symfony\\Bundle\\FrameworkBundle\\EventDispatcher',
                70 => 'Symfony\\Component\\Form\\FormConfiguration',
            ),
            ...
            'profiler.storage.file' => 'C:\\www\\test\\sandbox\\app/cache/dev/profiler.db',
            ...
            'twig.options' => array(
                'charset' => 'UTF-8',
                'debug' => true,
                'cache' => 'C:\\www\\test\\sandbox\\app/cache/dev/twig',
            ...
            'doctrine.orm.metadata_driver.entity_dirs' => array(
                0 => 'C:\\www\\test\\sandbox\\src\\Application\\UserBundle/Entity',
            ),
...
',
            'zend.logger.path' => 'C:\\www\\test\\sandbox\\app/logs/dev.log',
        );
    }
}
