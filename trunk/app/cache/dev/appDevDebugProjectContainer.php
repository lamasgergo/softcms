...
class appDevDebugProjectContainer extends Container implements TaggedContainerInterface
{
    ...
    protected function getRouting_Loader_RealService()
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader(array('Application' => 'C:\\htdocs\\test\\app/../src/Application', 'Bundle' => 'C:\\htdocs\\test\\app/../src/Bundle', 'Symfony\\Bundle' => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle')));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader(array('Application' => 'C:\\htdocs\\test\\app/../src/Application', 'Bundle' => 'C:\\htdocs\\test\\app/../src/Bundle', 'Symfony\\Bundle' => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle')));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader(array('Application' => 'C:\\htdocs\\test\\app/../src/Application', 'Bundle' => 'C:\\htdocs\\test\\app/../src/Bundle', 'Symfony\\Bundle' => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle')));
    ...
    {
        return $this->services['router'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), 'C:\\htdocs\\test\\app/config/routing_dev.yml', array('cache_dir' => 'C:\\htdocs\\test\\app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'app_devUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'app_devUrlMatcher'));
    }
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator(new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\htdocs\\test\\src\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle\\DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array())))), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array()));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:\\htdocs\\test\\app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => 'C:\\htdocs\\test\\app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['translator'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => 'C:\\htdocs\\test\\app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SQLiteProfilerStorage('C:\\htdocs\\test\\app/cache/dev/profiler.db', 86400), $this->get('logger'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('charset' => 'UTF-8', 'debug' => true, 'cache' => 'C:\\htdocs\\test\\app/cache/dev/twig', 'strict_variables' => true));
    ...
    {
        return $this->services['twig.loader'] = new \Symfony\Bundle\TwigBundle\Loader\FilesystemLoader($this->get('templating.name_parser'), array(0 => 'C:\\htdocs\\test\\app/views/%bundle%/%controller%/%name%.%renderer%.%format%', 1 => 'C:\\htdocs\\test\\app/../src/Application/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%', 2 => 'C:\\htdocs\\test\\app/../src/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%', 3 => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%'), $this->get('logger'));
    }
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('C:\\htdocs\\test\\app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\htdocs\\test\\app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\htdocs\\test\\app/cache/dev',
            'kernel.logs_dir' => 'C:\\htdocs\\test\\app/logs',
            'kernel.bundle_dirs' => array(
                'Application' => 'C:\\htdocs\\test\\app/../src/Application',
                'Bundle' => 'C:\\htdocs\\test\\app/../src/Bundle',
                'Symfony\\Bundle' => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle',
            ),
            ...
            'routing.resource' => 'C:\\htdocs\\test\\app/config/routing_dev.yml',
            ...
            'templating.loader.filesystem.path' => array(
                0 => 'C:\\htdocs\\test\\app/views/%bundle%/%controller%/%name%.%renderer%.%format%',
                1 => 'C:\\htdocs\\test\\app/../src/Application/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
                2 => 'C:\\htdocs\\test\\app/../src/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
                3 => 'C:\\htdocs\\test\\app/../src/vendor/symfony/src/Symfony/Bundle/%bundle%/Resources/views/%controller%/%name%.%renderer%.%format%',
            ),
            ...
            'translation.resources' => array(
                0 => array(
                    0 => 'xliff',
                    1 => 'C:\\htdocs\\test\\src\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.fr.xliff',
                    2 => 'fr',
                    3 => 'validators',
                ),
            ),
            ...
            'profiler.storage.file' => 'C:\\htdocs\\test\\app/cache/dev/profiler.db',
            ...
            'twig.options' => array(
                'charset' => 'UTF-8',
                'debug' => true,
                'cache' => 'C:\\htdocs\\test\\app/cache/dev/twig',
...
',
            'zend.logger.path' => 'C:\\htdocs\\test\\app/logs/dev.log',
