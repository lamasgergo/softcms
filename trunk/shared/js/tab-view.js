  ...
  ************************************************************************************************************/   
  ...
  function showTab(parentId,tabIndex)
  {
    ...
    if(activeTabIndex[parentId]>=0){
      ...
      img.src = '/source/images/tab/tab_right_inactive.gif';
    ...
    img.src = '/source/images/tab/tab_right_active.gif';
  ...
  function rolloverTab()
  {
    if(this.className.indexOf('tabInactive')>=0){
      ...
      img.src = '/source/images/tab/tab_right_over.gif';
    }
