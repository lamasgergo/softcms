...
switch($type){
	case 'image':
		...
		printf('<div class="icon image"><img src="phpthumb%20for%20less%20then%20PHP%205.3.x/phpThumb.php?h=140&amp;w=140&amp;far=1&amp;src=%s&bg=0000FF" alt="%s" /></div>', urlencode($uploadpath), $filename);
