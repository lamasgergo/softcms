<?php /* Smarty version 2.6.19, created on 2010-03-13 12:25:37
         compiled from C:%5Chtdocs%5Cphp4%5Chypermarket%5Cadmin%5Cmodules%5Cbase/templates/items//table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//table.tpl', 7, false),array('modifier', 'lang', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//table.tpl', 7, false),array('modifier', 'ShowCntCategory', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//table.tpl', 21, false),array('modifier', 'default', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//table.tpl', 21, false),array('modifier', 'date_format', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//table.tpl', 26, false),)), $this); ?>
    ...
    <table id="myTable">
      <thead>
        <tr>
          ...
          <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['module'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_Title') : smarty_modifier_cat($_tmp, '_Title')))) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
          <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['module'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_CategoryID') : smarty_modifier_cat($_tmp, '_CategoryID')))) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
          ...
          <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['module'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_created') : smarty_modifier_cat($_tmp, '_created')))) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
        </tr>
      </thead>
