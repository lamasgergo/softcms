<?php /* Smarty version 2.6.19, created on 2010-03-13 12:25:50
         compiled from C:%5Chtdocs%5Cphp4%5Chypermarket%5Cadmin%5Cmodules%5Cbase/templates/items//form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//form.tpl', 12, false),array('modifier', 'cat', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//form.tpl', 56, false),array('modifier', 'lang', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//form.tpl', 56, false),array('modifier', 'date_format', 'C:\\htdocs\\php4\\hypermarket\\admin\\modules\\base/templates/items//form.tpl', 65, false),)), $this); ?>
...
>
		...
		<tr>
				<td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['module'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_AllowComments') : smarty_modifier_cat($_tmp, '_AllowComments')))) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
				<td>
...
">
			<?php if ($this->_tpl_vars['form'] == 'change'): ?>
				<input type="submit" name="<?php echo $this->_tpl_vars['module']; ?>
_apply" value="<?php echo ((is_array($_tmp='button_apply')) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
" class="form_but" onclick="send_form('EXForm', '<?php echo $this->_tpl_vars['module']; ?>
', '<?php echo $this->_tpl_vars['component']; ?>
', '<?php echo $this->_tpl_vars['component']; ?>
