<?php /* Smarty version 2.6.19, created on 2010-03-02 20:48:25
         compiled from gallery/items/table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'gallery/items/table.tpl', 7, false),array('modifier', 'lang', 'gallery/items/table.tpl', 7, false),array('modifier', 'getCatalogNameById', 'gallery/items/table.tpl', 22, false),array('modifier', 'default', 'gallery/items/table.tpl', 22, false),array('modifier', 'date_format', 'gallery/items/table.tpl', 28, false),)), $this); ?>
    ...
    <table id="myTable">
      <thead>
        <tr>
          ...
          <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['prefix'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_Price') : smarty_modifier_cat($_tmp, '_Price')))) ? $this->_run_mod_handler('lang', true, $_tmp) : smarty_modifier_lang($_tmp)); ?>
</td>
...
"></td>
          ...
          <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['CategoryID'])) ? $this->_run_mod_handler('getCatalogNameById', true, $_tmp) : smarty_modifier_getCatalogNameById($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, "&nbsp;") : smarty_modifier_default($_tmp, "&nbsp;")); ?>
</td>
          <td><?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['Price'])) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0')); ?>
</td>
          <td>
