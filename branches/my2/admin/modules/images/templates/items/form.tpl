...
<div class="right">
    ...
    <fieldset>
        <legend>{"Images"|lang:$component}</legend>

        <dl>
            <dt><label for="Upload">{"Upload Images"|lang:$component}</label></dt>
            <dd>
                <input type="file" id="Upload" name="src" />
                <input type="button" name="Upload" value="{"Upload"|lang:$component}" style="width: auto;"/>
            </dd>
        </dl>
