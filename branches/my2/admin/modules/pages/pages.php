...
class Pages extends TabElement {
...
//        $this->smarty->assign("items_arr", $this->getValue());
        ...
        $tableTpl = $this->templatePath . '/table.tpl';
        if (!file_exists($tableTpl)){
            $tableTpl = 'admin/modules/table.tpl';
        }
        return $this->smarty->fetch($tableTpl, null, $this->language);
    }
