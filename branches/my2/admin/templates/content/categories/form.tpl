...
<table border="0" cellpadding="5" cellspacing="0" class="content"
	...
	<tr valign="top">
		...
		<table border="0" cellpadding="5" cellspacing="0" class="content">
			<!--
			<tr>
				<td>{$prefix|cat:"_LangID"|lang}<span class="required">*</span></td>
				<td>
			...
			<tr>
				<td>{$prefix|cat:"_AllowComments"|lang}</td>
				<td>
	...
	<tr valign="bottom">
		<td align="right">
            ...
            {if $form=='change'}
				<input type="submit" name="{$prefix}_apply" value="{'button_apply'|lang}" class="form_but" onclick="send_form('EXForm', '{$prefix}', '{$tab_prefix}', '{$tab_prefix}_{$form}', true); return false;">
			{/if}
			<input type="submit" name="{$prefix}_vendors" value="{'button_'|cat:$form|lang}" class="form_but" onclick="send_form('EXForm', '{$prefix}', '{$tab_prefix}', '{$tab_prefix}_{$form}'); return false;">
		</td>
	</tr>
</table>
</form>
